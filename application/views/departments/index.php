...
<?php foreach ($users as $user):?>
    <tr>
        <td data-order="<?php echo $user['id']; ?>" data-id="<?php echo $user['id'];?>">
            ...
            <a href="#" class="confirm-edit" title="Delete user"><i class="mdi mdi-pencil"></i></a>
...
<?php endforeach ?>
  ...
  <div class="row-fluid">
      <div class="col-12">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="mdi mdi-plus"></i>&nbsp;Create new department</button>
...
<div id="frmConfirmDelete" class="modal hide fade" tabindex="-1" role="dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <!-- <p>You are going to delete a department.</p> -->
