          ...
          <?php foreach ($users as $user):?>
            <tr>
              <td data-order="<?php echo $user['id']; ?>" data-id="<?php echo $user['id'];?>"  class="text-right">
                ...
                <a href="#" class="confirm-edit" title="edit material"><i class="mdi mdi-pencil"></i></a>
                <a href="#" class="confirm-delete" title="Delete material"><i class="mdi mdi-delete"></i></a>
                <?php echo $user['id'] ?>&nbsp;
              </td>
    ...
    <div class="row-fluid">
      <div class="col-12">
       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
         <i class="mdi mdi-plus-circle"></i>&nbsp;Create new meterial
       </button>
       <!-- The Modal -->
           ...
           <div class="modal-content">
             ...
             <div class="modal-body ">
              <div class="form-inline">
                <label class="control-label" for="firstname">meterial</label>&nbsp;
...
<div id="frmConfirmEdit" class="modal hide fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-inline">
          <label for="">Meterials</label> &nbsp;<input type="text" class="form-control">
        </div>
      </div>
      <div class="modal-footer">
