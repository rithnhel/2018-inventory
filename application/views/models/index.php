...
<div class="row-fluid">
 <div class="col-md-12 col-sm-4">
    ...
    <div class="row">
      <div class="col-md-4">
        <a type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal"><i class="mdi mdi-plus-circle"></i>&nbsp;Create new Models</a>
      </div>
      <div class="col-md-4"></div>
      <div class="col-md-4 text-right">
        <a type="button" class="btn btn-primary btn-lg btn-left"><i class="mdi mdi-arrow-left-bold-circle"></i>&nbsp;Back to brands</a>
      </div>
    </div>  
</div>
</div>
